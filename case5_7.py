...
if __name__ == '__main__':
    ...
    N_list = [4,8,16,32]
    for didx,Nant in enumerate(N_list):
        mvdr_rmse.append([])
        music_rmse.append([])
        dbt_rmse.append([])
        '''
    ...
    plt.figure()
    plt.title('DBT Number of Elements')
    plt.plot(-1*np.asarray(noise_powers),10*np.log10(dbt_rmse[0]),label=f'Nant={N_list[0]}')
    plt.plot(-1*np.asarray(noise_powers),10*np.log10(dbt_rmse[1]),label=f'Nant={N_list[1]}')
    plt.plot(-1*np.asarray(noise_powers),10*np.log10(dbt_rmse[2]),label=f'Nant={N_list[2]}')
    plt.xlabel('SNR (dB)')
    plt.ylabel('RMSE (db(degrees))')
    plt.legend()
    plt.savefig('report_figures/case5.png')
    
    plt.figure()
    plt.title('MVDR Number of Elements')
    plt.plot(-1*np.asarray(noise_powers),10*np.log10(mvdr_rmse[0]),label=f'Nant={N_list[0]}')
    plt.plot(-1*np.asarray(noise_powers),10*np.log10(mvdr_rmse[1]),label=f'Nant={N_list[1]}')
    plt.plot(-1*np.asarray(noise_powers),10*np.log10(mvdr_rmse[2]),label=f'Nant={N_list[2]}')
    plt.xlabel('SNR (dB)')
    plt.ylabel('RMSE (db(degrees))')
    plt.legend()
    plt.savefig('report_figures/case6.png')

    plt.figure()
    plt.title('MUSIC Number of Elements')
    plt.plot(-1*np.asarray(noise_powers),10*np.log10(music_rmse[0]),label=f'Nant={N_list[0]}')
    plt.plot(-1*np.asarray(noise_powers),10*np.log10(music_rmse[1]),label=f'Nant={N_list[1]}')
    plt.plot(-1*np.asarray(noise_powers),10*np.log10(music_rmse[2]),label=f'Nant={N_list[2]}')
    plt.xlabel('SNR (dB)')
    plt.ylabel('RMSE (db(degrees))')
    plt.legend()
    plt.savefig('report_figures/case7.png')